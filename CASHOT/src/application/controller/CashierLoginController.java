...
/**
 * The CashierLoginController class controls the cashier's login screen. This
 * makes sure the employee has the proper permissions to make and log new
 * orders.
 * 
...
public class CashierLoginController implements EventHandler {
	...
	/**
	 * Sets the label for letting the user know they have incorrect information
	 * to blank to hide it.
	 * 
	 * @param event
	 */
	...
	/**
	 * Happens when the user presses enter or pressed log in, this method will
	 * check to see what information has been placed in the text fields, and
	 * compare them to the existing employees. If the employee is nonexistent,
